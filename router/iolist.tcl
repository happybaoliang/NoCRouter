...
# DVE full session
# Saved on Tue Jul 13 21:49:34 2010
# Designs open: 1
#   Sim: /home/dub/router/verif/tc_router_wrap/simv
...
# DVE version: D-2009.12_Full64
# DVE build date: Nov 13 2009 21:53:53


#<Session mode="Full" path="/home/dub/router/verif/tc_router_wrap/iolist.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{722 403} {1831 1053}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 547]
set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier]
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 547
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value 266
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 546} {height 256} {show_state normal} {dock_state left} {dock_on_new_line true} {child_hier_colhier 416} {child_hier_coltype 149} {child_hier_col1 0} {child_hier_col2 1}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 262]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1111
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 262
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1109} {height 261} {show_state normal} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{10 70} {1928 1179}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 557} {child_wave_right 1356} {child_wave_colname 274} {child_wave_colvalue 278} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_set_env SIMSETUP::SIMEXE {/home/dub/router/verif/tc_router_wrap/simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/home/dub/router/verif/tc_router_wrap/simv}] } {
gui_sim_run Ucli -exe simv -args {-ucligui } -dir /home/dub/router/verif/tc_router_wrap -nosource
}
}
...
gui_sg_addsignal -group ${Group1} { {testbench.dut.clk} {testbench.dut.reset} {testbench.dut.io_write} {testbench.dut.io_read} {testbench.dut.io_addr} {testbench.dut.io_write_data} {testbench.dut.io_read_data} {testbench.dut.io_done} {testbench.dut.error} {testbench.dut.router_address} {testbench.dut.cfg_req} {testbench.dut.cfg_write} {testbench.dut.cfg_addr} {testbench.dut.cfg_write_data} {testbench.dut.cfg_read_data} {testbench.dut.cfg_done} {testbench.dut.node_ctrl} {testbench.dut.node_status} {testbench.dut.node_rtr_channel_p} {testbench.dut.node_rtr_flow_ctrl_p} {testbench.dut.rtr_node_channel_p} {testbench.dut.rtr_node_flow_ctrl_p} {testbench.dut.cfg_read_data_p} {testbench.dut.cfg_done_p} {testbench.dut.node_error_p} {testbench.dut.rtr_error} {testbench.dut.errors} }
set {Group2} {Group2}
gui_sg_create ${Group2}
gui_sg_addsignal -group ${Group2} { {testbench.dut.rtr.vcr.ips[2].ipc.ivcs[0].ivcc.route_op} {testbench.dut.rtr.vcr.ips[2].ipc.ivcs[0].ivcc.route_port} {testbench.dut.rtr.vcr.ips[2].ipc.ivcs[0].ivcc.inc_rc} {testbench.dut.rtr.vcr.elig_op_ovc} {testbench.dut.rtr.vcr.ips[2].ipc.ivcs[0].ivcc.vc_req} {testbench.dut.rtr.vcr.ips[2].ipc.ivcs[0].ivcc.vc_gnt} }
set {Group3} {Group3}
...
gui_sg_addsignal -group ${Group5} { {testbench.dut.ports[2].node.rtl.route_op} }
set {Group6} {Group6}
gui_sg_create ${Group6}
gui_sg_addsignal -group ${Group6} { {testbench.dut.ports[2].node.route_port_rv} }
set {Group7} {Group7}
gui_sg_create ${Group7}
gui_sg_addsignal -group ${Group7} { {testbench.dut.ports[2].node.la_route_info_rv} {testbench.dut.rtr.vcr.ips[2].ipc.ivcs[0].ivcc.la_route_info_in} {testbench.dut.rtr.vcr.ips[2].ipc.ivcs[0].ivcc.hdff_push} }
set {Group8} {Group8}
gui_sg_create ${Group8}
gui_sg_addsignal -group ${Group8} { {testbench.dut.ports[2].node.packet_sent} {testbench.dut.ports[2].node.packet_to_self} {testbench.dut.ports[2].node.flit_data_rv_q} }
...
catch { gui_list_select -id ${Data.1} {testbench.dut.rtr_node_channel_p }}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 133456
...
gui_list_set_insertion_bar  -id ${Wave.1} -group {Group1} -item {testbench.dut.rtr_node_channel_p[0:101]} -position below
...
gui_marker_move -id ${Wave.1} {C1} 133456
gui_view_scroll -id ${Wave.1} -vertical -set 400

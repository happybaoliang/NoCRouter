...
rm_dc_scripts/dc.occ_config.tcl - Design Compiler Reference Methodology sample
                                  on-chip clocking configuration file.

                                  This file is included only when the reference
                                  methodology scripts are configured to include
                                  on-chip clocking in the design for test (DFT) 
                                  flow.
